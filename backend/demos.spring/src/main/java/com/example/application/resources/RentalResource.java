...
public class RentalResource {
	...
	@ApiResponses({
		@ApiResponse(code = 201, message = "Aluiler añadido"),
	...
	public void update(@ApiParam(value = "Identificador del alquiler") @PathVariable int id, @Valid @RequestBody RentalEditDTO item)
